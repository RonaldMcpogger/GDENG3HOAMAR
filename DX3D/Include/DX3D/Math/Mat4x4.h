// 4x4 matrices and transformation
#pragma once
...
namespace dx3d
{
	...
	public:
		...
		static Mat4x4 orthoLH(f32 width, f32 height, f32 zNear, f32 zFar) noexcept //orthographic calculation
		{
		...
		static Mat4x4 perspectiveFovLH(f32 fov, f32 aspect, f32 zNear, f32 zFar) noexcept //perspective calculation
		{
		...
		static Mat4x4 inverse(const Mat4x4& rhs) noexcept // inverse camera for view
		{
			Mat4x4 out{};
			Vec4 vec[3]{};
		...
		static f32 determinant(const Mat4x4& rhs) noexcept //for inverse camera
		{
		...
		Vec4 row(ui32 index) const // return a specified row
		{
