...
{
	return Mat4x4::inverse(m_object.getTransform().getRigidWorldMatrix());// inverse matrix for the view
}

dx3d::Mat4x4 dx3d::CameraComponent::getProjectionMatrix() const noexcept // projection
{
	return m_projection;
}

void dx3d::CameraComponent::setFarPlane(f32 farPlane) noexcept // how far camera can see
{
...
void dx3d::CameraComponent::setNearPlane(f32 nearPlane) noexcept // how close can camera see
{
...
void dx3d::CameraComponent::setFieldOfView(f32 fieldOfView) noexcept   //fov
{
...
void dx3d::CameraComponent::setViewportSize(const Rect& area) noexcept //viewport
{
